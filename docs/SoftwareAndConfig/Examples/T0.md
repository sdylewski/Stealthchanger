---
title: T0 Configuration Example
parent: Examples
---

# T0 Configuration Example

This is an example tool configuration file for T0 (Tool 0), compatible with klipper-toolchanger-easy.
