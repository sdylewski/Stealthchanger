---
title: EBB36 T1 Configuration Example
parent: Examples
---

# EBB36 T1 Configuration Example

This is an example tool configuration file for T1 (Tool 1) using an **EBB36** toolhead board, compatible with klipper-toolchanger-easy.
...
```ini
# Example tool configuration file for T1 (Tool 1) - EBB36 Board
...
[tool_probe T1]
pin: ^EBBT1:PB6  # OctoTap sensor pin
tool: 1
