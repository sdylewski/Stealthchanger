---
title: Nighthawk36 T1 Configuration Example
parent: Examples
---

# Nighthawk36 T1 Configuration Example

This is an example tool configuration file for T1 (Tool 1) using a **Nighthawk36** toolhead board, compatible with klipper-toolchanger-easy.
...
```ini
# Example tool configuration file for T1 (Tool 1) - Nighthawk36 Board
...
[tool_probe T1]
pin: ^NHT1:PB0  # OctoTap sensor pin
tool: 1
...
[adxl345 T1]
cs_pin: NHT1:PB1
spi_software_sclk_pin: NHT1:PB10
spi_software_mosi_pin: NHT1:PB11
spi_software_miso_pin: NHT1:PB2
axes_map: x,z,y
```
