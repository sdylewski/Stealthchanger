---
title: T1 Configuration Example
parent: Examples
---

# T1 Configuration Example

This is an example tool configuration file for T1 (Tool 1), compatible with klipper-toolchanger-easy.
...
```ini
# Example tool configuration file for T1 (Tool 1)
